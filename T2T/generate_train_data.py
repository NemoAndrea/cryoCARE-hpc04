...
def sample_coordinates_2D(mask, num_train_vols, num_val_vols, vol_dims=(96, 96)):
    """
    ...
    vol_dims : tuple(int, int)
        Dimensionality of the extracted volumes. Default: ``(96, 96)``
...
def extract_samples(even, odd, train_coords, val_coords, mean, std):
    if len(train_coords[0]) == 2:
        return extract_slices(even, odd, train_coords, val_coords, mean, std)
    elif len(train_coords[0]) == 3:
